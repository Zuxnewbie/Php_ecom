	...
	<div class="login-cards">
		<div class="login-card">
			<div class="login-card-items">
				...
				<form method="post" action="index.php?action=dangnhap&act=dangnhap_action" class="form-items">
					<input type="text" placeholder="Username" name="txtusername">

					<div class="password-item">
						<input type="password" placeholder="Password" name="txtpassword" />
					</div>
					<!-- <button class="button-item" type="button" name="login" type="submit">login</button> -->
