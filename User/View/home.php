        ...
        <div class="carousel-item active">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p class="banner_text">Morning Fruit là thương hiệu trái cây tươi chất lượng cao, với đa dạng sản phẩm
                phục vụ mọi nhu cầu: đặc sản vùng miền, trái cây nhập khẩu, quà tặng trái cây, mâm ngũ quả, nước ép, và
                trái cây sấy.</p>
            </div>
          </div>
        </div>
      ...
      while ($set = $result->fetch()):
        ...
        <div class="col-md-3">
          <div class="box_section">
            ...
            <div class="buy_bt_1 active"><a
                href="./index.php?action=sanpham&act=sanphamchitiet&id=<?php echo $set['mahh'] ?>">Details
